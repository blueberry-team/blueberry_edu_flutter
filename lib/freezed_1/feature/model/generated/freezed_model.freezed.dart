...
class _$FreezedModelImpl implements _FreezedModel {
  const _$FreezedModelImpl({required this.name, required this.country});
  ...
  @override
  String toString() {
    return 'FreezedModel(name: $name, country: $country)';
  }
...
abstract class _FreezedModel implements FreezedModel {
  const factory _FreezedModel(
      ...
      required final String country}) = _$FreezedModelImpl;
